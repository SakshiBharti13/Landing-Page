...
function createAbout() {
    ...
    aboutText.innerHTML = "<p>Holidays is the ultimate app for your weekend getaways, business and holiday trips.</br></br>Pay less for more by comparing holiday providers as well as host reviews across sites!</p>"
...
function createPricing() {
    ...
    const pricingCards = [
        {
            pricing: "Free",
            description: "Free Holidays offers excellent options.",
            price: "$0"
        },
        {
            pricing: "Deluxe",
...
function createTest() {
    ...
    const testimonials = [
        ...
        {
            quote: "These days I couldn't imagine how our business would function, if we never had invested in Holidays! Not only did we increase passngers on flights but fully book our hotels.",
